...
#include "DxeImageVerification.h"
...
EFI_STATUS
EFIAPI
DxeImageVerificationConstructor (
  ...
  )
{
  EFI_EVENT                           Event;
  EFI_STATUS                          Status;
  EDKII_SECURITY_MANAGEMENT_PROTOCOL  *SecurityManagement;
  ...
  return SecurityManagement->RegisterSecurity2Handler (
                               DxeImageVerificationHandler,
