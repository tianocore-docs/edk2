...
#include "PhysicalPresenceInternal.h"
  ...
  )
{
  ...
  mTcg2PpStringPackHandle = HiiAddPackages (&gEfiTcg2PhysicalPresenceGuid, gImageHandle, DxeTcg2PhysicalPresenceStrings, NULL);
  ...
  )
{
  ...
  Status = gBS->InstallMultipleProtocolInterfaces (
                  &Handle,
                  &gEdkiiTcg2PhysicalPresenceProtocolGuid,
                  &mTcg2PhysicalPresenceProtocol,
                  NULL
                  );
  ASSERT_EFI_ERROR(Status);
