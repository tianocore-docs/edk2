...
#ifndef _EMU_SMM_CPU_H_
#define _EMU_SMM_CPU_H_
...
#include <Protocol/EmuSmmTrigger.h>
#include <Protocol/EmuSmmInfo.h>
#include <Protocol/EmuSmmCpu.h>
...
#define SMM_CPU_OFFSET(Field) OFFSET_OF (EMU_SMM_SAVE_STATE, Field)
...
typedef struct {
  ...
  UINT8                           CommandPort;
  UINT8                           DataPort;
  EMU_SMM_TRIGGER_PROTOCOL        SmmTrigger;

  EMU_SMM_SAVE_STATE              SmmSaveState;
  EMU_SMM_CPU_PROTOCOL            SmmCpu;
