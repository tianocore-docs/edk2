...
#define FIRMWARE_MANUFACTURER_STR "EDK II PEI"
...
EFI_STATUS
EFIAPI
Platform800155EventPeiEntryPoint (
  ...
  )
{
  ...
  TcgSp800155PlatformIdEventStruct = BuildGuidHob (&gTcg800155PlatformIdEventHobGuid, TcgSp800155PlatformIdEventStructSize);
