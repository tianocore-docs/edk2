/** @file
  ...
  on EDKII SMM Crypto Protocol in SMM phase.
...
EDKII_SMM_CRYPT_PROTOCOL  *mSmmCryptProtocol = NULL;

/**
  Constructor of SMM Crypto Library Instance.
  This function locates the EDKII SMM Crypt Protocol.
  ...
  )
{
  ...
  Status = gSmst->SmmLocateProtocol (
                    ...
                    NULL,
                    (VOID**) &mSmmCryptProtocol
                  );
  ASSERT_EFI_ERROR (Status);
  ASSERT (mSmmCryptProtocol != NULL);
...
{
  if (mSmmCryptProtocol == NULL) {
    return 0;
  }

  return mSmmCryptProtocol->Md5GetContextSize ();
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Md5Init (Md5Context);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Md5Duplicate (Md5Context, NewMd5Context);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Md5Update (Md5Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Md5Final (Md5Context, HashValue);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Md5HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha1GetContextSize ();
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha1Init (Sha1Context);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha1Duplicate (Sha1Context, NewSha1Context);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha1Update (Sha1Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha1Final (Sha1Context, HashValue);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha1HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha256GetContextSize ();
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha256Init (Sha256Context);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha256Duplicate (Sha256Context, NewSha256Context);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha256Update (Sha256Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha256Final (Sha256Context, HashValue);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Sha256HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->HmacSha256GetContextSize ();
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->HmacSha256New ();
}
  ...
  )
{
  ...
  mSmmCryptProtocol->HmacSha256Free (HmacSha256Ctx);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->HmacSha256Init (HmacSha256Context, Key, KeySize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->HmacSha256Duplicate (HmacSha256Context, NewHmacSha256Context);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->HmacSha256Update (HmacSha256Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->HmacSha256Final (HmacSha256Context, HmacValue);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->AesGetContextSize ();
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->AesInit (AesContext, Key, KeyLength);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->AesEcbEncrypt (AesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->AesEcbDecrypt (AesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->AesCbcEncrypt (AesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->AesCbcDecrypt (AesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->RsaNew ();
}
  ...
  )
{
  ...
  mSmmCryptProtocol->RsaFree (RsaContext);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->RsaSetKey (RsaContext, KeyTag, BigNumber, BnSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->RsaPkcs1Verify (RsaContext, MessageHash, HashSize, Signature, SigSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->RsaGetPrivateKeyFromPem (PemData, PemSize, Password, RsaContext);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->X509GetSubjectName (Cert, CertSize, CertSubject, SubjectSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->X509GetCommonName (Cert, CertSize, CommonName, CommonNameSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->X509VerifyCert (Cert, CertSize, CACert, CACertSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->X509ConstructCertificate (Cert, CertSize, SingleX509Cert);
}
  ...
  )
{
  ...
  mSmmCryptProtocol->X509Free (X509Cert);
}
  ...
  )
{
  ...
  mSmmCryptProtocol->X509StackFree (X509Stack);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->X509GetTBSCert (Cert, CertSize, TBSCert, TBSCertSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->Pkcs5HashPassword (PasswordLength, Password, SaltLength, Salt,
  ...
  )
{
  ...
  return mSmmCryptProtocol->Pkcs7Verify (P7Data, P7Length,
  ...
  )
{
  ...
  return mSmmCryptProtocol->RandomSeed (Seed, SeedSize);
}
  ...
  )
{
  ...
  return mSmmCryptProtocol->RandomBytes (Output, Size);
}
