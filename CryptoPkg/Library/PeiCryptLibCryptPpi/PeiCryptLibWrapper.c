/** @file
  ...
  on EDKII Crypto PPI in PEI phase.
...
/**
  Retrieve the EDKII_PEI_CRYPT_PPI pointer.

  This function is to locate EDKII_PEI_CRYPT_PPI PPI via PeiService.
  If fail to locate EDKII_PEI_CRYPT_PPI, then ASSERT_EFI_ERROR().

  @retval EDKII_PEI_CRYPT_PPI * The pointer to the EDKII_PEI_CRYPT_PPI.
...
{
  EFI_STATUS           Status;
  EDKII_PEI_CRYPT_PPI  *CryptPpi;

  Status = PeiServicesLocatePpi (&gEdkiiPeiCryptPpiGuid, 0, NULL, (VOID **)&CryptPpi);
...
{
  return GetCryptPpiPointer()->Md5GetContextSize ();
}
...
{
  return GetCryptPpiPointer()->Md5Init (Md5Context);
}
...
{
  return GetCryptPpiPointer()->Md5Duplicate (Md5Context, NewMd5Context);
}
...
{
  return GetCryptPpiPointer()->Md5Update (Md5Context, Data, DataSize);
}
...
{
  return GetCryptPpiPointer()->Md5Final (Md5Context, HashValue);
}
...
{
  return GetCryptPpiPointer()->Md5HashAll (Data, DataSize, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha1GetContextSize ();
}
...
{
  return GetCryptPpiPointer()->Sha1Init (Sha1Context);
}
...
{
  return GetCryptPpiPointer()->Sha1Duplicate (Sha1Context, NewSha1Context);
}
...
{
  return GetCryptPpiPointer()->Sha1Update (Sha1Context, Data, DataSize);
}
...
{
  return GetCryptPpiPointer()->Sha1Final (Sha1Context, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha1HashAll (Data, DataSize, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha256GetContextSize ();
}
...
{
  return GetCryptPpiPointer()->Sha256Init (Sha256Context);
}
...
{
  return GetCryptPpiPointer()->Sha256Duplicate (Sha256Context, NewSha256Context);
}
...
{
  return GetCryptPpiPointer()->Sha256Update (Sha256Context, Data, DataSize);
}
...
{
  return GetCryptPpiPointer()->Sha256Final (Sha256Context, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha256HashAll (Data, DataSize, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha384GetContextSize ();
}
...
{
  return GetCryptPpiPointer()->Sha384Init (Sha384Context);
}
...
{
  return GetCryptPpiPointer()->Sha384Duplicate (Sha384Context, NewSha384Context);
}
...
{
  return GetCryptPpiPointer()->Sha384Update (Sha384Context, Data, DataSize);
}
...
{
  return GetCryptPpiPointer()->Sha384Final (Sha384Context, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha384HashAll (Data, DataSize, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha512GetContextSize ();
}
...
{
  return GetCryptPpiPointer()->Sha512Init (Sha512Context);
}
...
{
  return GetCryptPpiPointer()->Sha512Duplicate (Sha512Context, NewSha512Context);
}
...
{
  return GetCryptPpiPointer()->Sha512Update (Sha512Context, Data, DataSize);
}
...
{
  return GetCryptPpiPointer()->Sha512Final (Sha512Context, HashValue);
}
...
{
  return GetCryptPpiPointer()->Sha512HashAll (Data, DataSize, HashValue);
}
...
{
  return GetCryptPpiPointer()->RsaNew ();
}
...
{
  GetCryptPpiPointer()->RsaFree (RsaContext);
}
...
{
  return GetCryptPpiPointer()->RsaSetKey (RsaContext, KeyTag, BigNumber, BnSize);
}
...
{
  return GetCryptPpiPointer()->RsaPkcs1Verify (RsaContext, MessageHash, HashSize, Signature, SigSize);
}
...
{
  return GetCryptPpiPointer()->Pkcs7Verify (P7Data, P7Length,
