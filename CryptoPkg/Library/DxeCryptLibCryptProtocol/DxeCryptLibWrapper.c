/** @file
  Library instance that implements BaseCryptLib library class based
  on EDKII Crypto Protocol in DXE phase.
...
EDKII_CRYPT_PROTOCOL  *mCryptProtocol = NULL;

/**
  Constructor of DXE Crypto Library Instance.
  This function locates the EDKII Crypt Protocol.
  ...
  )
{
  ...
  //
  // Locate EDKII Crypt Protocol Instance
  //
...
{
  if (mCryptProtocol == NULL) {
    return 0;
  }

  return mCryptProtocol->Md4GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->Md4Init (Md4Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md4Duplicate (Md4Context, NewMd4Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md4Update (Md4Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md4Final (Md4Context, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md4HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md5GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->Md5Init (Md5Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md5Duplicate (Md5Context, NewMd5Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md5Update (Md5Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md5Final (Md5Context, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Md5HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha1GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha1Init (Sha1Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha1Duplicate (Sha1Context, NewSha1Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha1Update (Sha1Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha1Final (Sha1Context, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha1HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha256Duplicate (Sha256Context, NewSha256Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha256Update (Sha256Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha256HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha384GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha384Init (Sha384Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha384Duplicate (Sha384Context, NewSha384Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha384Update (Sha384Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha384Final (Sha384Context, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha384HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha512GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha512Init (Sha512Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha512Duplicate (Sha512Context, NewSha512Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha512Update (Sha512Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha512Final (Sha512Context, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->Sha512HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacMd5GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacMd5New ();
}
  ...
  )
{
  ...
  mCryptProtocol->HmacMd5Free (HmacMd5Ctx);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacMd5Init (HmacMd5Context, Key, KeySize);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacMd5Duplicate (HmacMd5Context, NewHmacMd5Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacMd5Update (HmacMd5Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacMd5Final (HmacMd5Context, HmacValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha1GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha1New ();
}
  ...
  )
{
  ...
  mCryptProtocol->HmacSha1Free (HmacSha1Ctx);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha1Init (HmacSha1Context, Key, KeySize);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha1Duplicate (HmacSha1Context, NewHmacSha1Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha1Update (HmacSha1Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha1Final (HmacSha1Context, HmacValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha256GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha256New ();
}
  ...
  )
{
  ...
  mCryptProtocol->HmacSha256Free (HmacSha256Ctx);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha256Init (HmacSha256Context, Key, KeySize);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha256Duplicate (HmacSha256Context, NewHmacSha256Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha256Update (HmacSha256Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->HmacSha256Final (HmacSha256Context, HmacValue);
}
  ...
  )
{
  ...
  return mCryptProtocol->TdesGetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->TdesInit (TdesContext, Key, KeyLength);
}
  ...
  )
{
  ...
  return mCryptProtocol->TdesEcbEncrypt (TdesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->TdesEcbDecrypt (TdesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->TdesCbcEncrypt (TdesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->TdesCbcDecrypt (TdesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->AesGetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->AesInit (AesContext, Key, KeyLength);
}
  ...
  )
{
  ...
  return mCryptProtocol->AesEcbEncrypt (AesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->AesEcbDecrypt (AesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->AesCbcEncrypt (AesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->AesCbcDecrypt (AesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->Arc4GetContextSize ();
}
  ...
  )
{
  ...
  return mCryptProtocol->Arc4Init (Arc4Context, Key, KeySize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Arc4Encrypt (Arc4Context, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->Arc4Decrypt (Arc4Context, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mCryptProtocol->Arc4Reset (Arc4Context);
}
  ...
  )
{
  ...
  return mCryptProtocol->RsaGetKey (RsaContext, KeyTag, BigNumber, BnSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->RsaGenerateKey (RsaContext, ModulusLength, PublicExponent, PublicExponentSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->RsaCheckKey (RsaContext);
}
  ...
  )
{
  ...
  return mCryptProtocol->RsaPkcs1Sign (RsaContext, MessageHash, HashSize, Signature, SigSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->RsaPkcs1Verify (RsaContext, MessageHash, HashSize, Signature, SigSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->RsaGetPrivateKeyFromPem (PemData, PemSize, Password, RsaContext);
}
  ...
  )
{
  ...
  return mCryptProtocol->RsaGetPublicKeyFromX509 (Cert, CertSize, RsaContext);
}
  ...
  )
{
  ...
  return mCryptProtocol->X509GetSubjectName (Cert, CertSize, CertSubject, SubjectSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->X509GetCommonName (Cert, CertSize, CommonName, CommonNameSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->X509VerifyCert (Cert, CertSize, CACert, CACertSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->X509ConstructCertificate (Cert, CertSize, SingleX509Cert);
}
  ...
  )
{
  ...
  mCryptProtocol->X509Free (X509Cert);
}
  ...
  )
{
  ...
  mCryptProtocol->X509StackFree (X509Stack);
}
  ...
  )
{
  ...
  return mCryptProtocol->X509GetTBSCert (Cert, CertSize, TBSCert, TBSCertSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->Pkcs5HashPassword (PasswordLength, Password, SaltLength, Salt,
  ...
  )
{
  ...
  return mCryptProtocol->Pkcs7GetSigners (P7Data, P7Length, CertStack, StackLength,
  ...
  )
{
  ...
  mCryptProtocol->Pkcs7FreeSigners (Certs);
}
  ...
  )
{
  ...
  return mCryptProtocol->Pkcs7GetCertificatesList (P7Data, P7Length, SignerChainCerts,
  ...
  )
{
  ...
  return mCryptProtocol->Pkcs7Sign (PrivateKey, PrivateKeySize, KeyPassword, InData, InDataSize,
  ...
  )
{
  ...
  return mCryptProtocol->Pkcs7Verify (P7Data, P7Length,
                            TrustedCert, CertLength, InData, DataLength);
}
  ...
  )
{
  ...
  return mCryptProtocol->Pkcs7GetAttachedContent (P7Data, P7Length, Content, ContentSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->AuthenticodeVerify (AuthData, DataSize, TrustedCert,
  ...
  )
{
  ...
  return mCryptProtocol->ImageTimestampVerify (AuthData, DataSize, TsaCert, CertSize, SigningTime);
}
  ...
  )
{
  ...
  mCryptProtocol->DhFree (DhContext);
}
  ...
  )
{
  ...
  return mCryptProtocol->DhGenerateParameter (DhContext, Generator, PrimeLength, Prime);
}
  ...
  )
{
  ...
  return mCryptProtocol->DhSetParameter (DhContext, Generator, PrimeLength, Prime);
}
  ...
  )
{
  ...
  return mCryptProtocol->DhGenerateKey (DhContext, PublicKey, PublicKeySize);
}
  ...
  )
{
  ...
  return mCryptProtocol->DhComputeKey (DhContext, PeerPublicKey, 
  ...
  )
{
  ...
  return mCryptProtocol->RandomSeed (Seed, SeedSize);
}
  ...
  )
{
  ...
  return mCryptProtocol->RandomBytes (Output, Size);
}
