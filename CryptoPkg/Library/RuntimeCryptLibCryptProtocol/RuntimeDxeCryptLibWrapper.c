...
EDKII_RUNTIME_CRYPT_PROTOCOL  *mRuntimeCryptProtocol = NULL;
EFI_EVENT                     mCryptLibVirtualNotifyEvent;
  ...
  )
{
  ...
  //
  EfiConvertPointer (0x0, (VOID **) &mRuntimeCryptProtocol);
}
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (
                  &gEdkiiRuntimeCryptProtocolGuid,
                  NULL,
                  (VOID**) &mRuntimeCryptProtocol
                  );
  ASSERT_EFI_ERROR (Status);
  ASSERT (mRuntimeCryptProtocol != NULL);
  ...
  )
{
  ...
  //
  Status = gBS->CloseEvent (mCryptLibVirtualNotifyEvent);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Md5GetContextSize ();
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Md5Init (Md5Context);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Md5Duplicate (Md5Context, NewMd5Context);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Md5Update (Md5Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Md5Final (Md5Context, HashValue);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Md5HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha1GetContextSize ();
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha1Init (Sha1Context);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha1Duplicate (Sha1Context, NewSha1Context);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha1Update (Sha1Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha1Final (Sha1Context, HashValue);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha1HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha256GetContextSize ();
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha256Init (Sha256Context);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha256Duplicate (Sha256Context, NewSha256Context);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha256Update (Sha256Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha256Final (Sha256Context, HashValue);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Sha256HashAll (Data, DataSize, HashValue);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->HmacSha256GetContextSize ();
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->HmacSha256New ();
}
  ...
  )
{
  ...
  mRuntimeCryptProtocol->HmacSha256Free (HmacSha256Ctx);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->HmacSha256Init (HmacSha256Context, Key, KeySize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->HmacSha256Duplicate (HmacSha256Context, NewHmacSha256Context);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->HmacSha256Update (HmacSha256Context, Data, DataSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->HmacSha256Final (HmacSha256Context, HmacValue);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->AesGetContextSize ();
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->AesInit (AesContext, Key, KeyLength);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->AesEcbEncrypt (AesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->AesEcbDecrypt (AesContext, Input, InputSize, Output);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->AesCbcEncrypt (AesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->AesCbcDecrypt (AesContext, Input, InputSize, Ivec, Output);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->RsaNew ();
}
  ...
  )
{
  ...
  mRuntimeCryptProtocol->RsaFree (RsaContext);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->RsaSetKey (RsaContext, KeyTag, BigNumber, BnSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->RsaPkcs1Verify (RsaContext, MessageHash, HashSize, Signature, SigSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->RsaGetPrivateKeyFromPem (PemData, PemSize, Password, RsaContext);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->X509GetSubjectName (Cert, CertSize, CertSubject, SubjectSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->X509GetCommonName (Cert, CertSize, CommonName, CommonNameSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->X509VerifyCert (Cert, CertSize, CACert, CACertSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->X509ConstructCertificate (Cert, CertSize, SingleX509Cert);
}
  ...
  )
{
  ...
  mRuntimeCryptProtocol->X509Free (X509Cert);
}
  ...
  )
{
  ...
  mRuntimeCryptProtocol->X509StackFree (X509Stack);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->X509GetTBSCert (Cert, CertSize, TBSCert, TBSCertSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Pkcs5HashPassword (PasswordLength, Password, SaltLength, Salt,
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->Pkcs7Verify (P7Data, P7Length,
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->RandomSeed (Seed, SeedSize);
}
  ...
  )
{
  ...
  return mRuntimeCryptProtocol->RandomBytes (Output, Size);
}
