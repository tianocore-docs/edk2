/** @file
  This file declares EDKII Cryptographic Protocol.

  This protocol provides basic cryptograhpic services (including Hash, HMAC,
  RSA, DH, PKCS7, etc.) for DXE environment.
...
#ifndef __EDKII_CRYPT_PROTOCOL_H__
#define __EDKII_CRYPT_PROTOCOL_H__

#include <Library/BaseCryptLib.h>

// {7CBF9856-2832-46A8-9C06-A9AD40282ED5}
#define EDKII_CRYPT_PROTOCOL_GUID \
  { 0x7cbf9856, 0x2832, 0x46a8, { 0x9c, 0x6, 0xa9, 0xad, 0x40, 0x28, 0x2e, 0xd5 } };

typedef struct _EDKII_CRYPT_PROTOCOL EDKII_CRYPT_PROTOCOL;
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_MD4_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_MD4_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_MD4_HASHALL) (
  IN   CONST VOID  *Data,
  IN   UINTN       DataSize,
  OUT  UINT8       *HashValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_MD5_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_MD5_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_MD5_HASHALL) (
  IN   CONST VOID  *Data,
  IN   UINTN       DataSize,
  OUT  UINT8       *HashValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_SHA1_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA1_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA1_UPDATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA1_HASHALL) (
  IN   CONST VOID  *Data,
  IN   UINTN       DataSize,
  OUT  UINT8       *HashValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_SHA256_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA256_INIT) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA256_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA256_UPDATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA256_FINAL) (
  IN OUT  VOID   *Sha256Context,
  OUT     UINT8  *HashValue
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA256_HASHALL) (
  IN   CONST VOID  *Data,
  IN   UINTN       DataSize,
  OUT  UINT8       *HashValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_SHA384_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA384_INIT) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA384_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA384_UPDATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA384_FINAL) (
  IN OUT  VOID   *Sha384Context,
  OUT     UINT8  *HashValue
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA384_HASHALL) (
  IN   CONST VOID  *Data,
  IN   UINTN       DataSize,
  OUT  UINT8       *HashValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_SHA512_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA512_INIT) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA512_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA512_UPDATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA512_FINAL) (
  IN OUT  VOID   *Sha512Context,
  OUT     UINT8  *HashValue
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_SHA512_HASHALL) (
  IN   CONST VOID  *Data,
  IN   UINTN       DataSize,
  OUT  UINT8       *HashValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_HMAC_MD5_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
VOID *
(EFIAPI *EDKII_CRYPT_HMAC_MD5_NEW) (
  VOID
  );
...
typedef
VOID
(EFIAPI *EDKII_CRYPT_HMAC_MD5_FREE) (
  IN  VOID  *HmacMd5Ctx
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_MD5_INIT) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_MD5_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_MD5_UPDATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_MD5_FINAL) (
  IN OUT  VOID   *HmacMd5Context,
  OUT     UINT8  *HmacValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_HMAC_SHA1_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
VOID *
(EFIAPI *EDKII_CRYPT_HMAC_SHA1_NEW) (
  VOID
  );
...
typedef
VOID
(EFIAPI *EDKII_CRYPT_HMAC_SHA1_FREE) (
  IN  VOID  *HmacSha1Ctx
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA1_INIT) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA1_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA1_UPDATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA1_FINAL) (
  IN OUT  VOID   *HmacSha1Context,
  OUT     UINT8  *HmacValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_HMAC_SHA256_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
VOID *
(EFIAPI *EDKII_CRYPT_HMAC_SHA256_NEW) (
  VOID
  );
...
typedef
VOID
(EFIAPI *EDKII_CRYPT_HMAC_SHA256_FREE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA256_INIT) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA256_DUPLICATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA256_UPDATE) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_HMAC_SHA256_FINAL) (
  IN OUT  VOID   *HmacSha256Context,
  OUT     UINT8  *HmacValue
  );
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_TDES_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_TDES_ECB_ENCRYPT) (
  IN   VOID         *TdesContext,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_TDES_ECB_DECRYPT) (
  IN   VOID         *TdesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  OUT  UINT8        *Output
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_TDES_CBC_ENCRYPT) (
  IN   VOID         *TdesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  IN   CONST UINT8  *Ivec,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_TDES_CBC_DECRYPT) (
  IN   VOID         *TdesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  IN   CONST UINT8  *Ivec,
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_AES_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_AES_ECB_ENCRYPT) (
  IN   VOID         *AesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  OUT  UINT8        *Output
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_AES_ECB_DECRYPT) (
  IN   VOID         *AesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  OUT  UINT8        *Output
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_AES_CBC_ENCRYPT) (
  IN   VOID         *AesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  IN   CONST UINT8  *Ivec,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_AES_CBC_DECRYPT) (
  IN   VOID         *AesContext,
  IN   CONST UINT8  *Input,
  IN   UINTN        InputSize,
  IN   CONST UINT8  *Ivec,
...
typedef
UINTN
(EFIAPI *EDKII_CRYPT_ARC4_GET_CONTEXTSIZE) (
  VOID
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_ARC4_ENCRYPT) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_ARC4_DECRYPT) (
  IN OUT  VOID   *Arc4Context,
  IN      UINT8  *Input,
  IN      UINTN  InputSize,
  OUT     UINT8  *Output
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_SET_KEY) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_GET_KEY) (
  IN OUT  VOID         *RsaContext,
  IN      RSA_KEY_TAG  KeyTag,
  OUT     UINT8        *BigNumber,
  IN OUT  UINTN        *BnSize
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_GENERATE_KEY) (
  IN OUT  VOID         *RsaContext,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_CHECK_KEY) (
  IN  VOID  *RsaContext
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_PKCS1_SIGN) (
  IN      VOID         *RsaContext,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_PKCS1_VERIFY) (
  IN  VOID         *RsaContext,
  IN  CONST UINT8  *MessageHash,
  IN  UINTN        HashSize,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_GET_PRIVATE_KEY_FROM_PEM) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RSA_GET_PUBLIC_KEY_FROM_X509) (
  IN   CONST UINT8  *Cert,
  IN   UINTN        CertSize,
  OUT  VOID         **RsaContext
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_X509_GET_SUBJECT_NAME) (
  IN      CONST UINT8  *Cert,
  IN      UINTN        CertSize,
...
typedef
RETURN_STATUS
(EFIAPI *EDKII_CRYPT_X509_GET_COMMON_NAME) (
  IN      CONST UINT8  *Cert,
  IN      UINTN        CertSize,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_X509_VERIFY_CERT) (
  IN  CONST UINT8  *Cert,
  IN  UINTN        CertSize,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_X509_CONSTRUCT_CERTIFICATE) (
  IN   CONST UINT8  *Cert,
  IN   UINTN        CertSize,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_X509_CONSTRUCT_CERTIFICATE_STACK) (
...
typedef
VOID
(EFIAPI *EDKII_CRYPT_X509_STACK_FREE) (
  IN  VOID  *X509Stack
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_X509_GET_TBSCERT) (
  IN  CONST UINT8  *Cert,
  IN  UINTN        CertSize,
  OUT UINT8        **TBSCert,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_PKCS5_HASH_PASSWORD) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_PKCS7_GET_SIGNERS) (
...
typedef
VOID
(EFIAPI *EDKII_CRYPT_PKCS7_FREE_SIGNERS) (
  IN  UINT8        *Certs
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_PKCS7_GET_CERTIFICATES_LIST) (
  IN  CONST UINT8  *P7Data,
  IN  UINTN        P7Length,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_PKCS7_VERIFY) (
  IN  CONST UINT8  *P7Data,
  IN  UINTN        P7Length,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_PKCS7_GET_ATTACHED_CONTENT) (
  IN  CONST UINT8  *P7Data,
  IN  UINTN        P7Length,
  OUT VOID         **Content,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_AUTHENTICODE_VERIFY) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_IMAGE_TIMESTAMP_VERIFY) (
  IN  CONST UINT8  *AuthData,
  IN  UINTN        DataSize,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_DH_GENERATE_PARAMETER) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_DH_SET_PARAMETER) (
  IN OUT  VOID         *DhContext,
  IN      UINTN        Generator,
  IN      UINTN        PrimeLength,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_DH_GENERATE_KEY) (
  IN OUT  VOID   *DhContext,
  OUT     UINT8  *PublicKey,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_DH_COMPUTE_KEY) (
  IN OUT  VOID         *DhContext,
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RANDOM_SEED) (
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPT_RANDOM_BYTES) (
  OUT  UINT8  *Output,
  IN   UINTN  Size
  );
...
///
struct _EDKII_CRYPT_PROTOCOL {
  //
  // MD4 Hash
  //
  EDKII_CRYPT_MD4_GET_CONTEXTSIZE                 Md4GetContextSize;
  EDKII_CRYPT_MD4_INIT                            Md4Init;
  EDKII_CRYPT_MD4_DUPLICATE                       Md4Duplicate;
  EDKII_CRYPT_MD4_UPDATE                          Md4Update;
  EDKII_CRYPT_MD4_FINAL                           Md4Final;
  EDKII_CRYPT_MD4_HASHALL                         Md4HashAll;
  //
  // MD5 Hash
  //
  ...
  // SHA384 Hash
  //
  EDKII_CRYPT_SHA384_GET_CONTEXTSIZE              Sha384GetContextSize;
  EDKII_CRYPT_SHA384_INIT                         Sha384Init;
  EDKII_CRYPT_SHA384_DUPLICATE                    Sha384Duplicate;
  EDKII_CRYPT_SHA384_UPDATE                       Sha384Update;
  EDKII_CRYPT_SHA384_FINAL                        Sha384Final;
  EDKII_CRYPT_SHA384_HASHALL                      Sha384HashAll;
  //
  // SHA512 Hash
  //
  EDKII_CRYPT_SHA512_GET_CONTEXTSIZE              Sha512GetContextSize;
  EDKII_CRYPT_SHA512_INIT                         Sha512Init;
  EDKII_CRYPT_SHA512_DUPLICATE                    Sha512Duplicate;
  EDKII_CRYPT_SHA512_UPDATE                       Sha512Update;
  EDKII_CRYPT_SHA512_FINAL                        Sha512Final;
  EDKII_CRYPT_SHA512_HASHALL                      Sha512HashAll;

  //
  // HMAC-MD5
  //
  EDKII_CRYPT_HMAC_MD5_GET_CONTEXTSIZE            HmacMd5GetContextSize;
  EDKII_CRYPT_HMAC_MD5_NEW                        HmacMd5New;
  EDKII_CRYPT_HMAC_MD5_FREE                       HmacMd5Free;
  EDKII_CRYPT_HMAC_MD5_INIT                       HmacMd5Init;
  EDKII_CRYPT_HMAC_MD5_DUPLICATE                  HmacMd5Duplicate;
  EDKII_CRYPT_HMAC_MD5_UPDATE                     HmacMd5Update;
  EDKII_CRYPT_HMAC_MD5_FINAL                      HmacMd5Final;
  //
  // HMAC-SHA1
  //
  EDKII_CRYPT_HMAC_SHA1_GET_CONTEXTSIZE           HmacSha1GetContextSize;
  EDKII_CRYPT_HMAC_SHA1_NEW                       HmacSha1New;
  EDKII_CRYPT_HMAC_SHA1_FREE                      HmacSha1Free;
  EDKII_CRYPT_HMAC_SHA1_INIT                      HmacSha1Init;
  EDKII_CRYPT_HMAC_SHA1_DUPLICATE                 HmacSha1Duplicate;
  EDKII_CRYPT_HMAC_SHA1_UPDATE                    HmacSha1Update;
  EDKII_CRYPT_HMAC_SHA1_FINAL                     HmacSha1Final;
  //
  // HMAC-SHA256
  //
  ...
  // Triple-DES
  //
  EDKII_CRYPT_TDES_GET_CONTEXTSIZE                TdesGetContextSize;
  EDKII_CRYPT_TDES_INIT                           TdesInit;
  EDKII_CRYPT_TDES_ECB_ENCRYPT                    TdesEcbEncrypt;
  EDKII_CRYPT_TDES_ECB_DECRYPT                    TdesEcbDecrypt;
  EDKII_CRYPT_TDES_CBC_ENCRYPT                    TdesCbcEncrypt;
  EDKII_CRYPT_TDES_CBC_DECRYPT                    TdesCbcDecrypt;
  //
  // AES
  //
  ...
  // ARC4
  //
  EDKII_CRYPT_ARC4_GET_CONTEXTSIZE                Arc4GetContextSize;
  EDKII_CRYPT_ARC4_INIT                           Arc4Init;
  EDKII_CRYPT_ARC4_ENCRYPT                        Arc4Encrypt;
  EDKII_CRYPT_ARC4_DECRYPT                        Arc4Decrypt;
  EDKII_CRYPT_ARC4_RESET                          Arc4Reset;
  ...
  EDKII_CRYPT_RSA_GET_KEY                         RsaGetKey;
  EDKII_CRYPT_RSA_GENERATE_KEY                    RsaGenerateKey;
  EDKII_CRYPT_RSA_CHECK_KEY                       RsaCheckKey;
  EDKII_CRYPT_RSA_PKCS1_SIGN                      RsaPkcs1Sign;
  EDKII_CRYPT_RSA_PKCS1_VERIFY                    RsaPkcs1Verify;
  EDKII_CRYPT_RSA_GET_PRIVATE_KEY_FROM_PEM        RsaGetPrivateKeyFromPem;
  EDKII_CRYPT_RSA_GET_PUBLIC_KEY_FROM_X509        RsaGetPublicKeyFromX509;
  //
  // X.509
  //
  ...
  // PKCS#7
  //
  EDKII_CRYPT_PKCS7_GET_SIGNERS                   Pkcs7GetSigners;
  EDKII_CRYPT_PKCS7_FREE_SIGNERS                  Pkcs7FreeSigners;
  EDKII_CRYPT_PKCS7_GET_CERTIFICATES_LIST         Pkcs7GetCertificatesList;
  EDKII_CRYPT_PKCS7_SIGN                          Pkcs7Sign;
  EDKII_CRYPT_PKCS7_VERIFY                        Pkcs7Verify;
  EDKII_CRYPT_PKCS7_GET_ATTACHED_CONTENT          Pkcs7GetAttachedContent;
  //
  // Authenticode
  //
  EDKII_CRYPT_AUTHENTICODE_VERIFY                 AuthenticodeVerify;
  EDKII_CRYPT_IMAGE_TIMESTAMP_VERIFY              ImageTimestampVerify;
  //
  // Diffie-Hellman
  //
  EDKII_CRYPT_DH_NEW                              DhNew;
  EDKII_CRYPT_DH_FREE                             DhFree;
  EDKII_CRYPT_DH_GENERATE_PARAMETER               DhGenerateParameter;
  EDKII_CRYPT_DH_SET_PARAMETER                    DhSetParameter;
  EDKII_CRYPT_DH_GENERATE_KEY                     DhGenerateKey;
  EDKII_CRYPT_DH_COMPUTE_KEY                      DhComputeKey;
...
extern EFI_GUID gEdkiiCryptProtocolGuid;

#endif // __EDKII_CRYPT_PROTOCOL_H__
