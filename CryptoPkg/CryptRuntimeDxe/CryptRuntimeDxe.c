/** @file
  EDKII Runtime Cryptographic Driver Implementation, which produce one EDKII
  Runtime Crypt Protocol.
...
UINTN
EFIAPI
RuntimeCryptSha1GetContextSize (
  VOID
  )
{
...
UINTN
EFIAPI
RuntimeCryptHmacSha256GetContextSize (
  VOID
  )
{
...
BOOLEAN
EFIAPI
RuntimeCryptHmacSha256Duplicate (
...
BOOLEAN
EFIAPI
RuntimeCryptRsaGetPrivateKeyFromPem (
...
BOOLEAN
EFIAPI
RuntimeCryptX509GetSubjectName (
  IN      CONST UINT8  *Cert,
  IN      UINTN        CertSize,
...
BOOLEAN
EFIAPI
RuntimeCryptX509ConstructCertificate (
  IN   CONST UINT8  *Cert,
  IN   UINTN        CertSize,
...
BOOLEAN
EFIAPI
RuntimeCryptX509ConstructCertificateStack (
...
//
EDKII_RUNTIME_CRYPT_PROTOCOL  mEdkiiRuntimeCryptProtocol = {
  //
  // MD5 Hash
  //
  RuntimeCryptMd5GetContextSize,
